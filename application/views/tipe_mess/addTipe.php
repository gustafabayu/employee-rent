                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Form Tipe Mess Karyawan</span>
                        </div>
                    </div>
                    
                    <div class="portlet-body form"> 
                        <form action="<?php echo site_url('tipe_mess/tambah'); ?>" id="form_tipe" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="txtTipe" data-required="1" class="form-control" placeholder="Masukan tipe mess disini"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
