                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Form Group User</span>
                        </div>
                    </div>

                    <div class="portlet-body form">  
                        <form action="<?php echo site_url('lvl_user/tambah'); ?>" id="form_group" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Group User" class="form-control" name="txtLevel" />
                                            </div>
                                        </div>
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Keterangan" class="form-control" name="txtKet" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
