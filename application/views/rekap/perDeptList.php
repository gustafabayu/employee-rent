            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Rekap Bulanan Tagihan Listrik per departemen</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <form action="<?php echo site_url('rekap/deptPeriList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">                                        
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-success">
                                        <h5 class="uppercase"><strong>Periode dimunculkan : <?php echo $periodeDept; ?></strong></h5>                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="table_kwhmtr" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-condensed flip-content flip-scroll">
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($nmDept as $set){ ?>
                                    <tr>
                                        <td><?php echo ++$no; ?></td>
                                        <td><?php echo $set->NamaDept; ?></td>
                                        <?php if ($this->session->userdata('periodeDept') == NULL){ ?>
                                        <td class="uppercase"><strong>Silahkan Pilih Bulan Dahulu</strong></td>                                        
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('rekap/lihatOrgList')."?id=".$set->IDDept; ?>" class="btn btn-circle blue">
