            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Rekap Bulanan Tagihan Air per departemen</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <form action="<?php echo site_url('rekap/deptPeriAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">                                        
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($nmDept as $set){ ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('rekap/lihatOrgAir')."?id=".$set->IDDept; ?>" class="btn btn-circle blue">
