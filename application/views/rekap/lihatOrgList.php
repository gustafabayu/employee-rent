                    ...
                    <div class="portlet-body">                        
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle btn-danger" href='<?php echo base_url("rekap/perDeptList"); ?>'>
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($alamatList as $set){ ?>
                                    <tr>
                                        ...
                                        <td><strong><?php echo $set->KwhAwal; ?></strong></td>
                                        <td><strong><?php echo $set->Kwh; ?></strong></td>
...
<script>
    var table = $('#table_kwhmtr');
        ...
        var tableWrapper = $('#table_kwhmtr_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
