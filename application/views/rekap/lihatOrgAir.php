                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle btn-danger" href='<?php echo base_url("rekap/perDeptAir"); ?>'>
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($alamatAir as $set){ ?>
                                    <tr>
                                        ...
                                        <td><strong><?php echo $set->FlowAwal; ?></strong></td>
                                        <td><strong><?php echo $set->Flow; ?></strong></td>
