                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <form action="<?php echo site_url('rekap/PeriList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">                                        
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('rekap/blokList')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
