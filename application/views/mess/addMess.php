...
<!--                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2me" data-placeholder="Pilih Nama Blok" name="txtNmBlok" id="txtNmBlok" >                                                    
                                                    <option value=""></option>
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <div class="radio-list" data-error-container="#form_2_membership_error">
                                                    <label><input type="radio" name="txtStatus" value="0" /> Berpenghuni </label>
                                                    <label><input type="radio" name="txtStatus" value="1" /> Kosong </label>
                                                </div>
    ...
    $(document).ready(function(){
        ...
        form3.validate({
            ...
            messages: { // custom messages for radio buttons and checkboxes
                ...
                txtStatus: {
                    required: "Silahkan pilih status mess"
                },
                service: {
