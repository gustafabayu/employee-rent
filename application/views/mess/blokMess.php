                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        ...
                                        <a id="table_mess_new" class="btn btn-circle green-haze" href='<?php echo base_url("mess/addMess")."?id=".$set->IDBlok; ?>'>
                                            Tambah Data <i class="fa fa-plus"></i>
                                        </a>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle btn-danger" href='<?php echo base_url("mess/index"); ?>'>
                            ...
                            <tbody>
                                <?php $n = 0; foreach ($getMess as $setM) { ?>
                                    <tr >
                                        ...
                                        <td><strong><?php $this->load->model('m_mess'); $b = $this->m_mess->blokMess2($setM->IDBlok);
                                            foreach ($b as $setB): echo $setB->NamaBlok; endforeach;?></strong></td>
                                        <td><?php $this->load->model('m_mess'); $M = $this->m_mess->selectMess($setM->IDTipe);
                                            foreach ($M as $set): echo $set->TipeMess; endforeach;?></td>                                        
                                        ...
                                        <td><strong><?php $this->load->model('m_mess'); $K = $this->m_mess->selectKwh($setM->IDKwh);
                                            foreach ($K as $set): echo $set->Nomor; endforeach; ?></strong></td>                                        
                                        <td><strong><?php $this->load->model('m_mess'); $F = $this->m_mess->selectFlow($setM->IDFlowMtr);
                                            foreach ($F as $set): echo $set->Nomor; endforeach; ?></strong></td>
                                        <td><?php
                                            if ($setM->Status === 0) {
                                                echo "<span class='label label-primary'>Berpenghuni</span>";
                                            } else {
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('mess/editMess') . "?id=" . $setM->IDMess; ?>" class="btn btn-circle blue">
