            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">  
                        ...
                        <form action="<?php echo site_url('transaksi/tagList2'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Simpan Data?');">
                            <div class="form-body">                                    
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php echo $message; ?>
...
<!--                                        <input type="text" class="form-control" name="txtID"  value="<?php echo $row->ID ?>" readonly=""/>-->
                                        ...
                                        <div id="no_km">
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">                                                
                                                    <input type="text"  class="form-control" name="txtKwh" value="<?php echo $txtKwh; ?>" readonly=""/>
                                                </div>
                                            </div>                                        
                                        </div>-->
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">                                                
                                                <select class="form-control select2me" name="txtKwh" id="txtKwh" data-placeholder="Pilih Kwh Mess">
                                                    <option value=""></option>
                                                    <?php
                                                    foreach ($getKM as $set) {
                                        ...
                                        <div class="form-group">                                        
                                            <label class="control-label col-md-3">Biaya Per (kWh)<span class="required">
                                                    * </span>
                                            </label>
                                            <div class="col-md-6">
...
//                    minlength: 2,
            ...
            messages: { // custom messages for radio buttons and checkboxes
                txtBlnLalu: {
                    required: "Silahkan isi beban kwh meter bulan lalu"
                },
                txtBlnIni: {
                    required: "Silahkan isi beban kwh meter bulan ini"
                },
                txtBiayaPer: {
                    required: "Silahkan isi biaya per kwh"
                },
                txtBiaya: {
                    required: "Silahkan pilih tipe pemakai Kwh Meter"
                },
                txtKwh: {
