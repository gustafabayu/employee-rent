                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form"> 
                        <?php foreach ($getData as $row): ?>
                            <form action="<?php echo site_url('transaksi/tagAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Simpan Data?');">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php echo $message; ?>
