                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="btn-group">
                                        ...
                                        <a id="table_kwh_new" class="btn btn-circle green-haze" href='<?php echo base_url("transaksi/add_List")."?id=".$set->IDBlok; ?>'>
                                            <i class="fa fa-plus"></i> Tambah Tagihan
                                        </a>
                                        <?php endforeach; ?>
                                    </div>
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle btn-danger" href='<?php echo base_url("transaksi/listrik"); ?>'>
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($alamatList as $set){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('transaksi/bebanList')."?id=".$set->ID; ?>" class="btn btn-circle blue">
