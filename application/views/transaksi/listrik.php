                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <form action="<?php echo site_url('transaksi/PeriList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">                                        
                                    <label class="col-md-2 uppercase">Periode Aktif <span class="required">
                                                        * </span>
                                    </label>
                                    <div class="col-md-3">
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('transaksi/blokList')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
                                                <i class="fa fa-edit"></i> Proses Input</a>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
