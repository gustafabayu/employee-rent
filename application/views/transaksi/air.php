                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <form action="<?php echo site_url('transaksi/PeriAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">                                        
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('transaksi/blokAir')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
