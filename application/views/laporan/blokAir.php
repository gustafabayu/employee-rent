            ...
            <div class="col-md-12">                   
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                        <form action="<?php echo site_url('laporan/appAir1'); ?>" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
                        ...
                        <table id="table_ceklapflow" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-hover flip-content flip-scroll">
                            <thead>
                                <tr>
<!--                                    <th class="table-checkbox"><input type="checkbox" onchange="check(this)"/></th>-->
                                    <th ><input type="checkbox" id="FlowAll" class="group-checkable" data-set="#table_ceklapflow .checkboxes"/></th>
                                    <th>No</th>
                                    <th>Nama Mess</th>                                        
                                    <th>No Flow Mtr</th>
                                    <th>Periode</th>
...
<script>
    var table = $('#table_ceklapflow');
        ...
        var tableWrapper = jQuery('#table_ceklapflow_wrapper');
        ...
        <div class="row">
            <div class="col-md-12">                   
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                        <form action="<?php echo site_url('laporan/appAir2'); ?>" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-success">
                        ...
                        <table id="table_applapflow" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-hover flip-content flip-scroll">
                            <thead>
                                <tr>
<!--                                    <th class="table-checkbox"><input type="checkbox" onchange="check(this)"/></th>-->
                                    <th ><input type="checkbox" id="FlowAll" class="group-checkable" data-set="#table_applapflow .checkboxes"/></th>
                                    <th>No</th>
                                    <th>Nama Mess</th>                                        
                                    <th>No Flow Mtr</th>
                                    <th>Periode</th>
...
<script>
    var table = $('#table_applapflow');
        ...
        var tableWrapper = jQuery('#table_applapflow_wrapper');
