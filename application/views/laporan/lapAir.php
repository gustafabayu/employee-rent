            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Form Laporan Tagihan Air Mess</span>
                        </div>
                    </div>

                    <div class="portlet-body form"> 
                        <?php foreach ($getData1 as $row): ?>
                            <form action="<?php echo site_url('laporan/checkAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="txtBlnLalu" value="<?php echo $row->FlowAwal ?>" onKeyUp="getValues()" />
                                                </div>
                                            </div>                                        
                                            <div class="form-group" > 
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="txtBlnIni" value="<?php echo $row->Flow ?>" onKeyUp="getValues()"/>
                                                </div>
                                            </div>
                                            <div class="form-group">                                        
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">                                                    
                                                    <input type="text"  class="form-control" name="txtTtlBiaya" value="<?php echo $row->TtlBiaya ?>" onKeyUp="getValues()" readonly=""/>
                                                </div>
                                            </div>
...
<!--                                            <a type="button" href="<?php echo site_url('laporan/air'); ?>" class="btn btn-circle btn-danger"><i class="fa fa-undo"></i> Batal</a>-->
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form"> 
                        <?php foreach ($getData2 as $set): ?>
                            <form action="<?php echo site_url('laporan/approveAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text"  class="form-control" name="txtFlow"  value="<?php echo $set->Nomor ?>" readonly=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">                                        
                                                <label class="control-label col-md-3">Periode Bulan Tagihan 
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text"  class="form-control" name="txtBlnLalu" value="<?php echo $set->FlowAwal ?>" onKeyUp="getValues()" readonly=""/>
                                                </div>
                                            </div>                                        
                                            <div class="form-group" > 
                                                <label class="control-label col-md-3">Beban Bulan Ini (M<sup>3</sup>)
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text"  class="form-control" name="txtBlnIni" value="<?php echo $set->Flow ?>" onKeyUp="getValues()" readonly=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">                                        
                                                <label class="control-label col-md-3">Pemakaian (M<sup>3</sup>)
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">                                                    
                                                    <input type="text"  class="form-control" name="txtTtlBiaya" value="<?php echo $set->TtlBiaya ?>" onKeyUp="getValues()" readonly=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">                                        
                                                <label class="control-label col-md-3">Keterangan
