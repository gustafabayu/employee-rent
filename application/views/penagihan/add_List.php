            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Form Penagihan Listrik Mess</span>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form action="<?php echo site_url('penagihan/tambahList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
    ...
    $(document).ready(function() {
        ...
        form3.validate({
            ...
            messages: {// custom messages for radio buttons and checkboxes
                ...
                txtDenda: {
                    required: "Silahkan isi denda jika tidak ada isikan angka 0"
                },
                txtTtlBiaya: {
