            ...
            <div class="col-md-12">                   
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Penagihan Tagihan Air Mess</span>
                        </div>
                    </div>
...
<!--                                    <div class="btn-group">
                                        ...
                                        <a id="table_kwh_new" class="btn btn-circle green-haze" href='<?php echo base_url("penagihan/add_Air")."?id=".$set->IDBlok; ?>'>
                                            <i class="fa fa-plus"></i> Tambah Tagihan
                                        </a>
                                        <?php endforeach; ?>
                                    </div>-->
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle btn-danger" href='<?php echo base_url("penagihan/air"); ?>'>
                        ...
                        <table id="table_hitTagAir" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-condensed flip-content flip-scroll">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Mess</th>                                        
...
<!--                                        <td <?php if ($setF->Pemakaian <= 4) { echo "style=\"background-color:#fd6969\""; }?>><strong><?php echo $setF->Pemakaian; ?></strong></td>-->
                                        ...
                                        <td><?php if(($setF->AppTagihan === 0)||($setF->AppTagihan === NULL)){ ?>
                                            <a href="<?php echo site_url('penagihan/tagihAir')."?id=".$setF->ID; ?>" class="btn btn-circle blue">
                                                <i class="fa fa-edit"></i> Input Tagihan</a>
                                            <?php } else { ?>
                                            <?php } ?>
                                        </td>
                                        <td><?php if($setF->AppTagihan === 1){ ?>
                                            <a href="<?php echo site_url('penagihan/UpdTagAir')."?id=".$setF->ID; ?>" class="btn btn-circle yellow-gold"><i class="fa fa-pencil"></i> Update</a>
                                            <?php } else { ?>
                                            <?php } ?>
                                        </td>
                                        <td><?php if($setF->AppTagihan === 1){ ?>
                                            <a href="<?php echo site_url('penagihan/cekTagAir')."?id=".$setF->ID; ?>" class="btn btn-circle red">                                              
                                                <i class="fa fa-pencil"></i> Periksa</a>
                                            <?php } else { ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
        ...
        <div class="row">
            <div class="col-md-12">                   
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Penagihan Tagihan Air Mess non flow</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <table id="table_hitTagAirNon" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-condensed flip-content flip-scroll">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Mess</th>                                        
...
<!--                                    <th>Pemakaian</th>-->
                            ...
                            <tbody>
                                <?php $no2 = 0; foreach ($alamatAir2 as $setF){ ?>
                                    <tr>
                                        <td><?php echo ++$no2; ?></td>
                                        <td><strong><?php $this->load->model('m_penagihan'); $a = $this->m_penagihan->selectAlamat($setF->IDMess);
                                            foreach ($a as $set): echo $set->Nama; endforeach; ?></strong></td>
...
<!--                                        <td <?php if ($setF->Pemakaian <= 4) { echo "style=\"background-color:#fd6969\""; }?>><strong><?php echo $setF->Pemakaian; ?></strong></td>-->
                                        ...
                                        <td><?php if($setF->ApproveStatus === 1){ ?>
                                            <a href="<?php echo site_url('penagihan/UpdTagAirNon')."?id=".$setF->HeaderID; ?>" class="btn btn-circle yellow-gold"><i class="fa fa-pencil"></i> Update</a>
                                            <?php } else { ?>
                                            <?php } ?>
                                        </td>
                                        <td><?php if($setF->ApproveStatus === 1){ ?>
                                            <a href="<?php echo site_url('penagihan/cekTagAirNon')."?id=".$setF->HeaderID; ?>" class="btn btn-circle red">                                              
                                                <i class="fa fa-pencil"></i> Periksa</a>
                                            <?php } else { ?>
                                            <?php } ?>
                                        </td>
...
<script>
    var table = $('#table_hitTagAir');
        ...
        var tableWrapper = $('#table_hitTagAir_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
        tableWrapper.find('.dataTables_length select').select2(); // initialize select2 dropdown
</script>
<script>
    var table = $('#table_hitTagAirNon');
        ...
        var tableWrapper = $('#table_hitTagAirNon_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
        tableWrapper.find('.dataTables_length select').select2(); // initialize select2 dropdown
</script>