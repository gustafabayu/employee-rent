                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                ?>
                                <form action="<?php echo site_url('penagihan/periAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">                                        
                                    <label class="col-md-2 uppercase">Lihat Periode <span class="required">
                                                        * </span>
                                    </label>
                                    <div class="col-md-3">
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php if ($this->session->userdata('blnaktif') == NULL){ ?>
                                        <td class="uppercase"><strong>Silahkan Pilih Bulan Dahulu</strong></td>                                        
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('penagihan/blokAir')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
