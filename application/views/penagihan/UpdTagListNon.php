            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">                        
                        <form action="<?php echo site_url('penagihan/updateTagListNon'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Perbarui Data? Silahkan Cek Kembali');">
...
<!--                                        <div class="form-group">                                        
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">                                                    
                                                <input type="text"  class="form-control" name="txtTtlBiaya" id="txtTtlBiaya" value="<?php echo $row->Biaya ?>" onKeyUp="getValues()"/>
                                            </div>
                                        </div>
                                        <div class="form-group">                                        
...
<!--                                                    <th class="text-center">No</th>-->
                                            ...
                                            <tbody>
                                                <?php $no = 0; foreach($beban_list as $l){                                                            
                                                    ...
                                                    echo '<td><input type="text" class="form-control" name="txtTagihan[]" value="'.$l->Tagihan.'"></td>';
                                                    echo '<td><input type="text" class="form-control" name="txtTunggakan[]" value="'.$l->Tunggakan.'" onKeyUp="getValues()"></td>';
                                                    echo '<td><input type="text" class="form-control" name="txtTotal[]" value="'.$l->Total.'"></td>';
                                                    echo '</tr>';
                                                } ?>
                                            </tbody>
                                        </table>
