            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">                        
                        <form action="<?php echo site_url('penagihan/updateTagList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Perbarui Data? Silahkan Cek Kembali');">
