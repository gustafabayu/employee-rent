            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">                         
                        <form action="<?php echo site_url('penagihan/simTagAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Approve Data? Silahkan Cek Kembali');">
...
//                                                        echo '<td class="text-center">'.++$no.'</td>';
                                                    ...
                                                    echo '<td><input type="text" class="form-control" name="txtDept[]" readonly value="'.$a->NamaDept.'"></td>';
                                                    echo '<td><input type="text" class="form-control" name="txtCV[]" readonly value="'.$a->NamaCV.'"></td>';
