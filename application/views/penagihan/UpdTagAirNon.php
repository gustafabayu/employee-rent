<div class="page-head">
    <div class="container-fluid">            
        <div class="page-title">
            <h1>Penagihan <small>Tagihan Air Mess Non Flow</small></h1>
        </div>            
    </div>
</div>
            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Form Penagihan Tagihan Air Mess Non Flow</span>
                        </div>
                    </div>

                    <div class="portlet-body form">                         
                        <form action="<?php echo site_url('penagihan/updateTagAirNon'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal" onsubmit="return confirm('Anda Yakin Perbarui Data? Silahkan Cek Kembali');">
