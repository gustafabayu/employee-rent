<div class="v-scroll">
    <table id="tbl_borongan" class="table table-condensed table-hover">
        <thead>
            <tr>
                <th >#</th>                
                <th >Nama</th>
        ...
        <tbody>
            ...
            foreach ($boro as $b) {
                ...
                echo '<button bariske = ' . $z . ' type="button" class="btn btn-xs blue btnselect">Pilih</button>';
                echo '</td>';                
                echo '<td class="id hide">' . $b->FixNo . '</td>';
                echo '<td class="nama">' . $b->Nama . '</td>';
                echo '<td class="nik">' . $b->Nik . '</td>';
                echo '<td class="dept">' . $b->DeptAbbr . '</td>';                
                echo '<td class="jab hide">' . $b->Jabatan . '</td>';
                echo '<td class="cv">' . $b->Perusahaan . '</td>';
                echo '</tr>';
            }
            ?>
        </tbody>
    ...
    $('.btnselect').click(function () {
        ...
        $('#tbl_keluarga > tbody:last-child').append(
                '<tr>\n\
                    ...
                    <td class="hide"><input type="text" class="form-control " name="txtRegNo[]"></td>\n\
                    <td class="hide"><input type="text" class="form-control " name="txtFixNo[]" value="'+id+'"></td>\n\
                    <td ><input name="txtNama[]" type="text" class="form-control" readonly="readonly" value="' + nama + '" ><input type="hidden" class="form-control " name="txtTKID[]" value="B'+id+'"></td>\n\
