            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">Form KWH Meter Mess</span>
                        </div>
                    </div>
                    
                    <div class="portlet-body form">
                        <?php foreach ($getData as $row): ?>
                        <form action="<?php echo site_url('kwh_mtr/tambah'); ?>" id="form_kwh" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">                                
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Nomor Kwh Meter" data-required="1" class="form-control" name="txtNomor" >
                                            </div>
                                        </div>
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Merk Kwh Meter"  class="form-control" name="txtMerk" >
                                            </div>
                                        </div>
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Spesifikasi Kwh Meter"  class="form-control" name="txtSpesifikasi" />
                                            </div>
                                        </div>
                                        <div class="form-group">                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2me" data-placeholder="Pilih Tipe Pemakai.." name="txtPemakai" >
                                                    <option value=""></option>
                                                    <?php
                                                    foreach ($PakaiList as $set) {
                                                        echo'<option value="' . $set->ID . '">' . $set->TipeMCB . '</option>';
                                                    }?>
                                                </select>                                                                                        
                                            </div>
                                        </div>
