                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Ubah Data KWH Meter Mess</span>
                        </div>
                    </div>

                    <div class="portlet-body form">                                              
                        <?php foreach ($getID as $row): ?>
                            <form action="<?php echo site_url('kwh_mtr/editKwh'); ?>" id="form_kwh" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" name="txtIDKwh"  class="form-control" value="<?php echo $row->IDKwh; ?>" required=""/>
                                                    ...
                                                    <select class="form-control select2me" id="txtPemakai" name="txtPemakai" >                                                        
                                                        ...
                                                        foreach ($PakaiList as $set):
                                                            if ($set->ID == $row->TipePakai) {
                                                                echo'<option value="' . $set->ID . '" selected>' . $set->TipeMCB . '</option>';                                                                
                                                                ?>                                                    
                                                                <?php
                                                            } else {
