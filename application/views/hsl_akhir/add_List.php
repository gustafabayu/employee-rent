                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Form Tagihan Listrik Mess</span>
                        </div>
                    </div>

                    <div class="portlet-body form"> 
                        <?php foreach ($getData as $row): ?>    
                            <form action="<?php echo site_url('hsl_akhir/tagListrik'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control select2me" data-placeholder="Pilih Nomor Kwh Meter.." name="txtKwh" id="txtKwh">
                                                        <option value=""></option>
                                                        <?php
                                                        foreach ($getNoKM as $set) {
...
<!--                                            <script type="text/javascript">
                                                $('#txtKwh').change(function () {
                                                    var txtKwh = {txtKwh: $("#txtKwh").val()};
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "<?php echo site_url('hsl_akhir/almtMess') ?>",
                                                        data: txtKwh,
                                            ...
                                            <div class="div_mess">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">                                            
                                                        <input type="text" class="form-control" id="txtAlamat" name="txtAlamat" readonly="readonly" value="<?php echo $txtAlamat; ?>"/>                                                                                                
                                                    </div>
                                                </div>
                                            </div>-->
                                            <div class="form-group">                                        
    ...
    $(document).ready(function() {
        ...
        form3.validate({
            ...
            messages: {// custom messages for radio buttons and checkboxes
                ...
                txtKwh: {
                    required: "Silahkan pilih nomor kwh meter bulan"
                },
                txtTtlBiaya: {
                    required: "Silahkan total biaya nomor Kwh Meter ini"
                },
                service: {
