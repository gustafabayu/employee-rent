                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form"> 
                        <?php foreach ($getData1 as $row): ?>
                            <form action="<?php echo site_url('laporan/checkAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form"> 
                        <?php foreach ($getData2 as $set): ?>
                            <form action="<?php echo site_url('laporan/approveAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
