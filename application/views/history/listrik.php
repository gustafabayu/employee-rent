                    ...
                    <div class="portlet-body">                        
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                ?>
                                <form action="<?php echo site_url('laporan/cariBlnList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">                                                                           
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('laporan/blokList')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
                    ...
                    <div class="portlet-body">                        
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                ?>
                                <form action="<?php echo site_url('laporan/cariBlnList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">                                                                           
                                    <label class="col-md-2 uppercase">Periode Bulan</label>
                                    <div class="col-md-3">
                                        <div class="input-group input-big date date-picker" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                            <input type="text" class="form-control"  name="txtBlnAwal">
                                            <span class="input-group-btn">
