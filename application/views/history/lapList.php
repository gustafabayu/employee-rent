            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">  
                        ...
                        <form action="<?php echo site_url('laporan/checkList'); ?>" id="form_tagList" method="post" role="form" class="form-horizontal">
                            <div class="form-body">                                    
                                <div class="row">
                                    <div class="col-md-12">
            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">  
                        ...
                        <form action="<?php echo site_url('laporan/approveList'); ?>" method="post" role="form" class="form-horizontal">
                            <div class="form-body">                                    
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="txtID" id="form_tagList" class="form-control" value="<?php echo $set->ID; ?>" required=""/>                                        
                                        <div class="form-group">                                        
                                            <label class="control-label col-md-3">Alamat Mess 
                                            </label>
                                            <div class="col-md-6">                                                
