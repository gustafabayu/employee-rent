<div class="page-head">
    <div class="container-fluid">            
        <div class="page-title">
            <h1>History <small>Tagihan Air Mess</small></h1>
        </div>            
    </div>
</div>
            ...
            <div class="col-md-12">                   
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">                            
                            <span class="caption-subject font-green-sharp bold uppercase">History Tagihan Air Mess</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">                        
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                ?>
                                <form action="<?php echo site_url('history/cariBlnAir'); ?>" id="form_tagAir" method="post" role="form" class="form-horizontal">                                                                           
                                    <label class="col-md-2 uppercase">Periode Bulan <span class="required">
                                                        * </span>
                                    </label>
                                    <div class="col-md-3">
                                        <div class="input-group input-big date date-picker" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                            <input type="text" class="form-control"  name="txtBlnAwal">
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                    <label class="col-md-1 uppercase">Sampai</label>
                                    <div class="col-md-3">
                                        <div class="input-group input-big date date-picker" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                                            <input type="text" class="form-control"  name="txtBlnAkhir">
                                            <span class="input-group-btn">
                                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-success">
                                        <h5 class="uppercase"><strong>Periode Yang Akan tampil dari: <?php echo $blnAwal; ?> sampai <?php echo $blnAkhir; ?></strong></h5>                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($blokMess as $set){ ?>
                                    <tr>
                                        ...
                                        <?php if (($this->session->userdata('blnAwal') == NULL)&&($this->session->userdata('blnAkhir') == NULL)){ ?>
                                        <td class="uppercase"><strong>Silahkan Pilih Bulan Dahulu</strong></td>                                        
                                        <?php } else { ?>
                                        <td>
                                            <a href="<?php echo site_url('history/blokAir')."?id=".$set->IDBlok; ?>" class="btn btn-circle blue">
    ...
    $(document).ready(function() {
        ...
        form3.validate({
            ...
            messages: {// custom messages for radio buttons and checkboxes
                txtBlnAwal: {
                    required: "Silahkan pilih periode bulan awal tagihan"
                },
                txtBlnAkhir: {
                    required: "Silahkan pilih periode bulan akhir tagihan"
                },
                txtFlow: {
