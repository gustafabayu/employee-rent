                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body form">                                                       
                        <?php foreach ($getData as $row): ?>
                            <form action="<?php echo site_url('harga/editFM'); ?>" id="form_flow" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-6">                                                    
                                                    <input type="text" value="<?php echo $row->Tipe; ?>" data-required="1" class="form-control" name="txtTipe" />
                                                </div>
                                            </div>
                                            <div class="form-group">                                        
...
//                },
            ...
            messages: { // custom messages for radio buttons and checkboxes
                ...
                txtTipe: {
                    required: "Silahkan isi tipe prnghuni mess"
                },
//                txtMerk: {
