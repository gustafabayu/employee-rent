...
<div class="page-head">
    <div class="container-fluid">            
        <div class="page-title">
            <h1>KWH Meter <small>Daftar Harga Listrik</small></h1>
        </div>            
    </div>
</div>
            ...
            <div class="col-md-12">                    
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Form Harga Listrik</span>
                        </div>
                    </div>

                    <div class="portlet-body form">    
                        <form action="<?php echo site_url('harga/tambahKM'); ?>" id="form_kwh" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Tipe MCB Mess" data-required="1" class="form-control" name="txtMCB" />
                                            </div>
                                        </div>
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="Harga Listrik Per Kwh"  class="form-control" name="txtHarga" />
                                            </div>
                                        </div>                                                                                
                                        <div class="form-group">                                        
...
//                },
            ...
            messages: { // custom messages for radio buttons and checkboxes
                ...
                txtMCB: {
                    required: "Silahkan isi tipe prnghuni mess berdasar MCB"
                },
//                txtMerk: {
...
//                },
                txtHarga: {
                    required: "Silahkan isi harga satuan listrik"
                },
                txtAlamat: {
