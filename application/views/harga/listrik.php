            ...
            <div class="col-md-12">                   
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Daftar Harga Listrik</span>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a id="table_flow_new" class="btn btn-circle green-haze" href='<?php echo base_url("harga/addKM"); ?>'>
                        ...
                        <table id="table_hrgList" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-condensed flip-content flip-scroll">
                            ...
                            <tbody>
                                <?php $no = 0; foreach ($hargaKM as $setF){?>
                                    <tr>
                                        <td><?php echo ++$no; ?></td>
                                        <td><?php echo $setF->TipeMCB; ?></td>
                                        <td><?php echo $setF->Harga; ?></td>                                                                               
                                        <td><?php echo $setF->Ket; ?></td>
                                        <td>
                                            <a href="<?php echo site_url('harga/editKM')."?id=".$setF->ID; ?>" class="btn btn-circle blue">
