                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase">Form Ganti Password User</span>
                        </div>
                    </div>

                    <div class="portlet-body form">                            
                        <?php foreach ($dataUser as $row): ?>
                            <form action="<?php echo site_url('password/update'); ?>" id="form_user" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php echo $message; ?>
                                            <input type="hidden" name="txtUserID"  class="form-control" value="<?php echo $row->Username; ?>" required=""/>
                                            <div class="form-group">                                            
                                                <label class="control-label col-md-3">Password Lama 
                                                </label>
                                                <div class="col-md-6">                                                                                                
                                                    <input type="password" value="<?php echo $row->Password; ?>" class="form-control" name="txtPassLama" readonly=""/>
                                                </div>
                                            </div>
                                            <div class="form-group">                                            
                                                ...
                                                <div class="col-md-6">                                            
                                                    <input type="password" placeholder="Masukan Password Baru" class="form-control" name="txtPassBaru" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(document).ready(function(){
        ...
        form3.validate({
            ...
            messages: { // custom messages for radio buttons and checkboxes
                ...
                txtPassBaru: {
                    required: "Silahkan isi Password baru untuk Login"
                },
                txtMerk: {
